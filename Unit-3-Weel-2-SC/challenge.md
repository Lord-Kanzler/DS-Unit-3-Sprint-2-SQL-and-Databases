...
# The relationship is One-to One. However, ther is no direct realtionship, as Employees and Territories don't have overlapping columns. A join on EmployeeTerretories would provide the matching TerritoryID keys. 

- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?

# If you need table joins MongoDB is kind of weak. MongoDB isn't for relational data purposes. If you look at the databases from this sprint you'd quickly realize the differences. For instance, the rpg_db has tables relating to one another, while the mongoDB we worked on contains collections of entries. 
